...
@NamedQueries({
    ...
    , @NamedQuery(name = "Payment.findByCardnumber", query = "SELECT p FROM Payment p WHERE p.paymentPK.cardnumber = :cardnumber")
...
public class Payment implements Serializable {
    ...
    public Payment(int customernumber, String cardnumber) {
        this.paymentPK = new PaymentPK(customernumber, cardnumber);
    }
    ...
    public String toString() {
        return "model.Payment[ paymentPK=" + paymentPK + " ]";
    }
